...
through the B<Parse> method. When all information is collected you can start the formatting through the B<Format> method. It is based
on the Template Toolkit.
...
B<Syntax::Kamelon::XMLData>, B<Syntax::Kamelon::Format::TT>
